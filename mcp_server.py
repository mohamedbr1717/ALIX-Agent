    ...
    def handle_request(self, req):
        ...
        if method == "initialize":
                    ...
                    "tools": [
                        {
                            ...
                            "description": "Static AST screening only -- flags Python code containing banned imports/names/attributes. Does NOT execute the code, and passing this check does NOT mean the code is safe to run (the screen is a bypassable denylist, not a sandbox).",
                            "inputSchema": {
                                "type": "object",
            ...
            if tool_name == "alix_check_code":
                # This only classifies the code (APPROVED/BLOCKED); it
                # never executes it. See alix_v4_1_unified.execute_task
                # and policy_watcher.inspect_code for why an APPROVED
                # verdict must not be treated as "safe to run".
